...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -pthread -shared -L/usr/local/sqlite-3.33/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall '
           '-I/usr/local/sqlite-3.33/include',
 'CFLAGSFORSHARED': '',
 'CFLAGS_ALIASING': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/usr/local/sqlite-3.33/include',
 'CONFIGURE_CFLAGS_NODIST': '-fno-semantic-interposition -std=c11 -Wextra '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-L/usr/local/sqlite-3.33/lib',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/usr/local/sqlite-3.33/lib',
 'LDVERSION': '3.12',
 'LIBC': '',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare '
                    '-DNDEBUG -g -O3 -Wall -I/usr/local/sqlite-3.33/include '
 ...
 'MODULE__CURSES_PANEL_LDFLAGS': '-lpanelw -lncursesw   -lncursesw',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g '
                             '-O3 -Wall -I/usr/local/sqlite-3.33/include '
                             '-fno-semantic-interposition -std=c11 -Wextra '
                             '-Wno-unused-parameter '
                             '-Wno-missing-field-initializers '
                             '-Wstrict-prototypes '
 ...
 'PY_CORE_LDFLAGS': '-L/usr/local/sqlite-3.33/lib -fno-semantic-interposition',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 0,
 'PY_HAVE_PERF_TRAMPOLINE': 1,
 'PY_LDFLAGS': '-L/usr/local/sqlite-3.33/lib',
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition',
 'PY_LDFLAGS_NOLTO': '-L/usr/local/sqlite-3.33/lib',
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 '
                        '-Wall -I/usr/local/sqlite-3.33/include '
                        '-fno-semantic-interposition -std=c11 -Wextra '
                        '-Wno-unused-parameter -Wno-missing-field-initializers '
                        '-Wstrict-prototypes '
                        '-Werror=implicit-function-declaration '
